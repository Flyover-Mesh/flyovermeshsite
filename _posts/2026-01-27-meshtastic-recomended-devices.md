...
| RAK wireless Wismesh Repeater Mini | ❌  | ❌     | ❌ No   | Everything you need for a solar node, at a lower price for the bundle.    |
...
**RAK Wismesh Solar Repeater Mini**
* [Rokland](https://store.rokland.com/products/wismesh-repeater-mini-reliable-coverage-expansion-for-smart-networks?ref=flyover)
* Pros / Cons
  * ✅ Bundle with everything you need, save money compared to the parts
  * ❌ Not portable - only for stationary builds, No GPS (or DIY GPS), needs flashing, could benefit from vent and external solar charge controller 

___


### 🙋 STILL NOT SURE?
* Get recomendations Discord
* Ask to see other people's nodes
